		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				case 1:
					...
					createCoolText(['TheRandomFiend', 'WeegeeDude', 'TheShadowGames'], -60);
					#else
				...
				case 4:
					#if PSYCH_WATERMARKS
					addMoreText('And many more o m g', -40);
					ngSpr.visible = true;
					ngSpr.visible = false;
					#else
				...
				// credTextShit.text += '\nNewgrounds';
					ngSpr.visible = false;
					addMoreText('They decided to', -20);
				case 7:
				// credTextShit.visible = false;
				// credTextShit.text = 'Shoutouts Tom Fulp';
				// credTextShit.screenCenter();
				addMoreText('yes I kid you not', -10);
				case 8:
				//createCoolText([curWacky[0]]);
				// credTextShit.visible = true;
				createCoolText(['fr'], 120);
				case 9:
					//addMoreText(curWacky[1]);
					deleteCoolText();
					createCoolText(['Kidnap 2 coders', 'and some other people'], 0);
					ngSpr.visible = false;
				// credTextShit.text += '\nlmao';
				case 10:
					deleteCoolText();
					addMoreText('To bring you', -20);
					//deleteCoolText();
				// credTextShit.visible = false;
				// credTextShit.text = "Friday";
				// credTextShit.screenCenter();
				case 11:
					addMoreText('Da funni mod', 10);
				case 12:
					addMoreText('Very Funni', 40);
				case 13:
					deleteCoolText();
				...
				case 16:
					addMoreText('WOOOOOOOOOOOOOOOO'); // credTextShit.text += '\nFunkin';
